...
` + ('Please change the parent <Route path="' + parentPath + '"> to <Route ') + ('path="' + (parentPath === "/" ? "*" : parentPath + "/*") + '">.'));
  ...
  async function getCompanies(params = { skip: 0, take: 20, sort: "recent", keyword: "" }) {
  ...
  var PopUp_default = {
    popUpWrapper: "PopUp_popUpWrapper",
    popUpContainer: "PopUp_popUpContainer",
    popUpText: "PopUp_popUpText",
    popUpCloseButton: "PopUp_popUpCloseButton"
  };
