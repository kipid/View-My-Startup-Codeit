      ...
      <div className={styles.container}>
        ...
        <div className={styles.myCompanyWrapper}>
          {!myCompany ? (
            ...
            <>
              <p
                className={styles.cancelMyCompany}
                onClick={() => handleDeleteMyCompany()}
              >
                선택 취소
              </p>
              <div className={styles.companyInfo}>
                <img
                  ...
                  src={myCompany.logo ? myCompany.logo : noLogo}
                  alt="로고"
                />
        ...
        <div className={styles.comparisonHeader}>
          ...
          <button
            className={`${styles.addComparisonButton} ${
              comparisons.length < 5 ? styles.active : styles.inactive
            }`}
          ...
          {comparisons.length === 0 ? (
            ...
            comparisons.map((comparison) => (
              <div className={styles.comparisonInfo} key={comparison.id}>
                ...
                <img
                  className={styles.companyLogo}
                  src={comparison.logo ? comparison.logo : noLogo}
                  alt="로고"
                />
                <div className={styles.comanyInfoText}>
